...
tester_params = {
    ...
    'seed': 2023,
    'model_load': {
        'path': 'pretrained/ensemble',  # directory path of pre-trained model and log files saved.
    ...
    'aug_factor': 8,
    'aug_batch_size': 5,
    'test_set_path': 'data/Size_Distribution/cvrp1000_explosion.pkl',
    'test_set_opt_sol_path': 'data/Size_Distribution/hgs/cvrp1000_explosionoffset0n1000-hgs.pkl'
}
...
fine_tune_params = {
    ...
    'k': 1,  # fine-tune steps/epochs
    'fine_tune_batch_size': 1,  # the batch size of the inner-loop optimization

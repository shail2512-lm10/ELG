...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': './result/20230718_131450_train_cvrp',  # directory path of pre-trained model and log files saved.
...
meta_params = {
    ...
    'meta_method': 'maml_fomaml',  # choose from ['maml', 'fomaml', 'maml_fomaml', 'reptile']
    ...
    'L': 0,  # bootstrap steps
    'meta_batch_size': 45,  # will be divided by 2 if problem_size >= 150

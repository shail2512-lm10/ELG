...
if __name__ == "__main__":
    ...
    # model = Localized_CVRPModel(**model_params)
    checkpoint = torch.load(load_checkpoint, map_location=device)
    # checkpoint['model_state_dict']['decoder.local_policy_0.Linear_1.weight'] = checkpoint['model_state_dict'].pop('decoder.edge_net.Linear_1.weight')
    # checkpoint['model_state_dict']['decoder.local_policy_0.Linear_1.bias'] = checkpoint['model_state_dict'].pop('decoder.edge_net.Linear_1.bias')
    # checkpoint['model_state_dict']['decoder.local_policy_0.Linear_2.weight'] = checkpoint['model_state_dict'].pop('decoder.edge_net.Linear_2.weight')
    # checkpoint['model_state_dict']['decoder.local_policy_0.Linear_2.bias'] = checkpoint['model_state_dict'].pop('decoder.edge_net.Linear_2.bias')
    # torch.save(checkpoint, 'weights/ELG_final.pt')
